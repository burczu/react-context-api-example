**The React Context API example made for the blog post purpose.** This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
